...
// Variables to emulate how to create objects inside iterations.
var candidate1 = "Bob"
var candidate2 = "Bob"
...
var object_creator = function(){
  ...
  console.log(voteCount) // You will see and "empty" object.
  console.log("")

  // here I created a 2 new objects inside  voteCount.vicePresident with value = to 0
  voteCount.vicePresident[candidate1] = 0
  voteCount.vicePresident[candidate2] = 0
  voteCount.vicePresident[candidate3] = 0 
  
  console.log("After adding objects")
  console.log(voteCount) // You will see
  console.log("")
  
  // Adding to each new object value
  for(i=1; i<=10;i++){
  voteCount.vicePresident[candidate1]++; // here I add 10 to candidate1
  }
  for(i=1; i<=5;i++){
  voteCount.vicePresident["Bob"]++; // here I add 5 to candidate2
  }
  for(i=1; i<=8;i++){
  voteCount.vicePresident[candidate3]++; // here I add 8 to candidate3
  }
...
// assert((voteCount.president["Bob"] === 3), "Bob should receive three votes for President.", "1. ")
